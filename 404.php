 ...
 .sign.error-page-wrapper .buttons-container a:hover .fa-home {
  ...
  @media screen and (max-width: 500px) {
   ...
   .sign.error-page-wrapper .buttons-container .fa {
    ...
    .pane {
      background-color: rgba(206, 41, 34, 1) !important;
    }
...
<div class="text-container">
	...
	<div class="context primary-text-color">
		<p>
			Du vil måske gå tilbage til forside.<br>
			Mener du at der er noget som er gået i stykke så rapporter det.
		</p>
	</div>
	<div class="buttons-container">
		<a class="border-button" href="/" target="_blank"><span class="fa fa-home"></span> Forside</a>
		<a class="border-button" href="mailto:info@inzite.dk" target="_blank"><span class="fa fa-warning"></span> Reporter Problem</a>
	</div>
</div>
